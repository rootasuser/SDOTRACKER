...
try {
    ...
    function checkIfEmployeeExists($empNumber, $conn) {
        $checkQuery = "SELECT COUNT(*) FROM employees WHERE empNumber = :empNumber";
        $stmt = $conn->prepare($checkQuery);
        $stmt->bindParam(':empNumber', $empNumber, PDO::PARAM_STR);
        $stmt->execute();
        
        // Fetch the result; if count > 0, employee exists
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (checkIfEmployeeExists($empNumber, $conn)) {
    ...
    <div class="card shadow-sm p-4">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <label for="empName" class="form-label text-dark">Name</label>
                        <input type="text" class="form-control" id="empName" name="empName" required>
                    </div>

                    <div class="col-md-4">
                        <label for="empNumber" class="form-label text-dark">Number</label>
                        <input type="number" class="form-control" id="empNumber" name="empNumber" required>
                    </div>

                    <div class="col-md-4">
                        <label for="empAddress" class="form-label text-dark">Address</label>
                ...
                <div class="row g-3 mt-3">
                    <div class="col-md-4">
                        <label for="empSex" class="form-label text-dark">Sex</label>
                    ...
                    <div class="col-md-4">
                        <label for="empPosition" class="form-label text-dark">Position</label>
                    ...
                    <div class="col-md-4">
                        <label for="empAssignSchool" class="form-label text-dark">School Assigned</label>
                ...
                <hr>
                <div class="mb-3 mt-2">
                        <label for="searchEmployeeSubject" class="form-label text-dark">Search Teaching Subject/s</label>
                        <input type="text" class="form-control" id="searchEmployeeSubject" onkeyup="searchCheckboxes()">
                    </div>

                    <!-- Teaching Subjects Selection -->
                    <div class="mt-3">
                        <label class="form-label text-dark">Select Teaching Subject/s</label>
                        <div class="row" style="max-height: 300px; overflow-y: auto;">
                            <div id="checkboxList"> <!-- ✅ ADD ID HERE FOR SEARCH -->
                                <?php 
                                $count = 0;
                        ...
                        <div class="col-md-4">
                        <div class="mb-3">
                            <label for="empHistory" class="form-label text-dark">School History</label>
